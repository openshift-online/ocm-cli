...
func (c *shim) bindRolesToServiceAccount(ctx context.Context, serviceAccount *cmv1.WifServiceAccount) error {
	serviceAccountId := serviceAccount.ServiceAccountId()
...
func (c *shim) bindRolesToGroup(ctx context.Context, groupEmail string, roles []*cmv1.WifRole) error {
	return c.bindRolesToPrincipal(
		ctx,
...
func (c *shim) bindRolesToPrincipal(ctx context.Context, principal string, roles []*cmv1.WifRole) error {
...
func (c *shim) fmtRoleResourceId(role *cmv1.WifRole) string {
	if role.Predefined() {
...
func (c *shim) getRole(ctx context.Context, roleName string) (*adminpb.Role, error) {
...
func (c *shim) createRole(ctx context.Context, permissions []string, roleTitle, roleId, roleDescription,
...
// Custom roles should follow the format projects/{project}/roles/{role_id}.
func (c *shim) updateRole(ctx context.Context, role *adminpb.Role, roleName string) (*adminpb.Role, error) {
...
func (c *shim) undeleteRole(ctx context.Context, roleName string) (*adminpb.Role, error) {
